...
function getResultsFromGoogle(searchtext, numOfPages, cb) {
    var count = 0;
    var arr = [];
    var MAX_REQUESTS = 10;
...
app.get('/pic', function(req, res) {
    getResultsFromGoogle('Samsung Galaxy Note 4 SM-N910C Black (FACTORY UNLOCKED) 5.7" QHD , 32GB , 16MP', 20, function(data) {
        res.jsonp(data);
    });
});
