          ...
          link: function (scope, element, attrs) {
              ...
              var dataFactory = {
                  ...
                  month: function (unixDate) {
                      ...
                      var activeDate = scope.ngModel ? moment(scope.ngModel, 'DD/MM/YYYY').format('YYYY-MM') : 0;
                  ...
                  day: function (unixDate) {
                      ...
                      var activeDate = scope.ngModel ? moment(scope.ngModel, 'DD/MM/YYYY').format('YYYY-MMM-DD') : '';
                  ...
                  hour: function (unixDate) {
                      ...
                      var activeFormat = scope.ngModel ? moment(scope.ngModel, 'DD/MM/YYYY').format('YYYY-MM-DD H') : '';
                  ...
                  minute: function (unixDate) {
                      ...
                      var activeFormat = scope.ngModel ? moment(scope.ngModel, 'DD/MM/YYYY').format('YYYY-MM-DD H:mm') : '';
                  ...
                  setTime: function (unixDate) {
                      ...
                      scope.ngModel = moment(newDate).format('DD/MM/YYYY');
              ...
              var getUTCTime = function () {
                  var tempDate = (scope.ngModel ? moment(scope.ngModel, 'DD/MM/YYYY').toDate() : new Date());
